...
export const ButtonComponent = ({
   ...
   return (
      <Link
         ...
         className={`px-0 xs:px-4 group flex gap-2 items-center justify-center bg-[#f1f1f1] text-xl text-slate-950 font-[880] drop-shadow-md rounded-full z-10 cursor-pointer button-hidden ${classname}`}
      >
